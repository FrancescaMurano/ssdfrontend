        ...
        <div className="h-300 flex flex-col p-2 min-w-full md:w-48 bg-white drop-shadow rounded-md">
            ...
            role === 'commessi' & !dress.deleted ? (
                ...
                <div key={
                    ...
                    <div className="flex p-1 border border-1 border-red/40 rounded bg-red-800/20 cursor-pointer"  onClick={
           ...
           <div className="grid pl-2 border grid-cols-2"><h3 className="font-medium">Material: </h3><h3>
                {
                dress.materialType
            }</h3></div>
            <div className="grid pl-2 border grid-cols-2"><h3 className="font-medium">Color: </h3><h3>
                {
                dress.colorType
            }</h3></div>
            <div className="grid pl-2 border grid-cols-2"><h3 className="font-medium">Size: </h3><h3>
                {
                dress.size
            }</h3></div>
           
            <div className="grid grid-cols-2 bg-gray-800/20 p-2 h-full w-full"><h3 className="font-medium" >Description: </h3><h3 className="break-words overflow-scroll">
                {
                dress.description
            }</h3></div>
            {
            ...
            <> {
                dress.deleted ? 
                (
                    <div className="grid pl-2 pt-1 pb-1  grid-cols-2 bg-red-800/40 "><h3 className="font-medium">Available: </h3><h3>
                    {
                    ...
                    <div className="grid pl-2 pt-1 pb-1  grid-cols-2 bg-green-800/40 "><h3 className="font-medium">Available: </h3><h3>
                    {
                    dress.deleted.toString()
                }</h3></div>)
                }
